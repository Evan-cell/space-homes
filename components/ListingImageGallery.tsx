        ...
        <div className="container mx-auto px-4 md:px-6 mb-8 md:mb-12">
            <div className="grid grid-cols-3 md:grid-cols-4 gap-2 md:gap-4 h-auto md:h-[500px]">
                ...
                <div className="col-span-3 md:col-span-2 row-span-1 md:row-span-2 relative overflow-hidden rounded-2xl md:rounded-3xl group shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-border aspect-[4/3] md:aspect-auto">
                    ...
                    />
                    <div className="absolute inset-x-0 bottom-0 p-4 md:p-8 bg-gradient-to-t from-black/60 to-transparent">
                ...
                {sideImages.map((img: string, i: number) => (
                    <div 
                        ...
                        className="col-span-1 md:col-span-1 row-span-1 md:row-span-1 relative overflow-hidden rounded-xl md:rounded-3xl group cursor-pointer border-2 border-transparent hover:border-primary/50 transition-all hover:shadow-xl hover:-translate-y-1 aspect-square md:aspect-auto"
                    >
                        <Image 
                            src={img} 
                            alt={`${title} thumbnail`} 
                ...
                {images.length < 4 && (
                    <div className="col-span-1 md:col-span-1 row-span-1 md:row-span-1 hidden md:flex relative overflow-hidden rounded-3xl bg-muted/30 border-2 border-dashed border-border items-center justify-center aspect-square md:aspect-auto">
